        ...
        <div class="main-content mt-15">
          <div class="data-content-panel">
            ...
            <el-table stripe class="huo-list-table main-theme-table" size="mini" highlight-current-row ref="dataTable1" :data="frontList">
              ...
              <el-table-column prop="rate" :label="actTab==1?'清欠率':'收缴率'" align="center" width="70">
                <template slot-scope="scope">
									<label v-text="(scope.row.rate.percentage || '-') + '%'"></label>
								</template>
              </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      tabList: [
        ...
        { name: '清欠率', disabled: false },
        { name: '投诉关闭率', disabled: true },
      ],
      tabListTime: [
  ...
  methods: {
    ...
    setFrontTableData() {
      ...
      request({
        url: `/app-api/healthlife/property/getDragonTiger`,
        method: 'post',
        data: {
